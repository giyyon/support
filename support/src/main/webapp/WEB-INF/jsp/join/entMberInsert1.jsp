        	...
        	<div id="content-group">
				...
				<%@ include file="../include/joinMenu.jsp" %>
                    ...
                    <div class="mem_info fll txt12">
                    	<ul>
                            <li>아래의 아이핀을 이용하여, 중복가입여부와 기관∙기업정보 실무관리자가 본인임을  확인합니다.</li>
                    ...
                    <div class="mem_info_sect">
                        ...
                        <div class="mem_box fl100">
                        	<div class="txt txt11">- 입력된 담당자정보는 다음단계의 회원정보입력시 변경할 수 없으므로, 정확히 입력하여 주시기 바랍니다.<br/>
							- 기존 회원일 경우, 인증버튼 클릭시 가입여부가 노출되므로 아이디찾기, 비밀번호찾기를 이용해 로그인하여 주시기 바랍니다. 
							 <br/>&nbsp;&nbsp;단, 개인정보보호를 위해 일부정보는 암호화되어 표기됩니다. 
							</div>
							<form:form commandName="entrprsManageVO"  id="form">
                        	<ul class="info_put fl100">
                            	<li><strong>담당자명(실명) :</strong><span class="con"><input name="name" type="text" class="w200"></span> </li>
                                ...
                                <li><strong>이메일 </strong>
                                    ...
                                    <form:select path="applcntEmailAdres" id="applcntEmailAdres" title="이메일">
...
<a href="#" class="link2">한국신용평가정보㈜</a> 등의 타기관에서 발급받은 아이핀도 사용가능합니다. 단, 아이디/비밀번호찾기는 아이핀 발급기관에서만 확인이 가능합니다.
 ...
 <script type="text/javaScript" language="javascript">
	...
	$( "#applcntEmailAdres" ) .change(function () {
		$("#emailTail").val(  $( "#applcntEmailAdres option:selected" ).val());  
   })    
        ...
        $.ajax({
            ...
            success: function (data, status) {
            	...
            	if(data.IsSucceed){
            		...
            		html = '<p>인증 성공</p>';
        			$body.append(html);    
            		$("form").attr({action:"${contextPath}/join/entMberInsertView2.do", target:""});	
            		$("form").submit();
            	}else {
