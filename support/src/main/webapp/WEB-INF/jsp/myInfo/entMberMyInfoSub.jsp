        	...
        	<div id="content-group">
            	...
            	<div id="contents" class="bg_cs">
                   ...
                   <input type="hidden" id="entrprsMiddleTelno" name="entrprsMiddleTelno" value="<c:out value='${entrprsManageVO.entrprsMiddleTelno}'/>">
                    ...
                    <input type="hidden" id="mngEmailAdres" name="mngEmailAdres" value='<c:out value='${entrprsManageVO.mngEmailAdres}'/>'' ><!-- 총괄책임자이메일주소 -->
                    <input type="hidden" id="taxEmailAdres" name="taxEmailAdres" value='<c:out value='${entrprsManageVO.taxEmailAdres}'/>'' ><!-- 세무담당자이메일주소 -->
...
<script type="text/javaScript" language="javascript">
	...
	$("form").attr({action:"${contextPath}/myInfo/updateEntSubMyInfo.do", target:""});   
