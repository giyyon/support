...
<%@ include file="../include/taglib.jsp" %>
	                            ...
	                            <tr>
	                                ...
	                                <td>
                          			...
                          			<td class="rmx">
		                                ...
		                                <a href="/myInfo/trendModify.do?nttId=<c:out value="${result.nttId}"/>"><img src="${contextPath}/img/ico_modify.png" alt="수정"></a>
		                                <a href="/myInfo/deleteTrendArticle.do?nttId=<c:out value="${result.nttId}"/>"><img src="${contextPath}/img/ico_delete.png" alt="삭제"></a>
	...
	function goDeleteArray(){
		...
		if(confirm("선택된 항목이 일괄 삭제 됩니다. \n 일괄 삭제하시겠습니까?")){
			$("#subForm").attr({action:"${contextPath}/myInfo/deleteCheckedTrendList.do"});
			$("#subForm").submit();
		}
	}	
