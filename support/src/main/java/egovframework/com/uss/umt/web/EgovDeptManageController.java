...
public class EgovDeptManageController {
	...
	public String selectDeptManageList(@ModelAttribute("deptManageVO") DeptManageVO deptManageVO,
	...
	public String insertViewDeptManage(@ModelAttribute("deptManageVO") DeptManageVO deptManageVO,
			                            ModelMap model) throws Exception {
	...
	public String insertDeptManage(@ModelAttribute("deptManageVO") DeptManageVO deptManageVO, 
	...
	public String updateDeptManage(@ModelAttribute("deptManageVO") DeptManageVO deptManageVO, 
			                        BindingResult bindingResult,
                                    SessionStatus status,
                                    ModelMap model) throws Exception {
    	beanValidator.validate(deptManageVO, bindingResult); //validation 수행
	...
	public String deleteDeptManage(@ModelAttribute("deptManageVO") DeptManageVO deptManageVO, 
                                    SessionStatus status,
	...
	public String deleteDeptManageList(@RequestParam("deptManages") String deptManages,
			                           @ModelAttribute("deptManageVO") DeptManageVO deptManageVO, 
			                            SessionStatus status, 
			                            ModelMap model) throws Exception {
