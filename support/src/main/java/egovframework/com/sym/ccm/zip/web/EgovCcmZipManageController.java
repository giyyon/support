...
public class EgovCcmZipManageController {
	...
	public String insertExcelZip(@ModelAttribute("loginVO") LoginVO loginVO, final HttpServletRequest request, @CommandMap Map<String, Object> commandMap, ZipVO searchVO, Model model)
			throws Exception {
		model.addAttribute("searchList", searchVO.getSearchList());
	...
	public String updateZip(@ModelAttribute("loginVO") LoginVO loginVO, @ModelAttribute("zip") Zip zip, ZipVO searchVO, BindingResult bindingResult, @CommandMap Map<String, Object> commandMap,
