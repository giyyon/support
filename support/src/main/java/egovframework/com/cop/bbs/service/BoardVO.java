...
public class BoardVO extends Board implements Serializable {
    ...
    private int seq = 0;
    		;
    /** 이전 혹은 다음 게시물 지정. prev/next */
    private String articleDirection = "";
	...
	/**
	 * @param sortTypeNm the sortTypeNm to set
	 */
	public void setSortTypeNm(String sortTypeNm) {
	
		this.sortTypeNm = sortTypeNm;
	}
	...
	/**
	 * @return the articleDirection
	 */
	public String getArticleDirection() {
	
		return articleDirection;
	}

	/**
	 * @param articleDirection the articleDirection to set
	 */
