...
public class TrendController implements ApplicationContextAware, InitializingBean {
	...
	Map<String, Object> map = bbsMngService.selectTrendArticleList(boardVO, "");
	...
	return ".basic_community/trendList";
    }
	...
	return ".basic_community/trendModify";
    }
...
//    		                                                      final MultipartHttpServletRequest multiRequest, 
		...
		if("01".equals(board.getNttSttusCode())){
			//임시 등록
			return "redirect:/community/trendModify.do";
		}else{
			//등록
			return "redirect:/community/trendList.do";
		}
    }
}
